    ...
    with gr.Blocks(css=css) as demo:
        ...
        with gr.Row():
            ...
            with gr.Column(scale=9):
                ...
                from utils import change_signature
                bot_fn = change_signature(['message', 'history'] + list(KWARGS.keys()))(_bot_fn) # better API
                chatbot = gr.ChatInterface(_bot_fn, # chatbot=_chatbot, textbox=_textbox,
                        additional_inputs=list(KWARGS.values()),
                        chatbot=gr.Chatbot(avatar_images = ["assets/user.png", "assets/bot.png"]),
